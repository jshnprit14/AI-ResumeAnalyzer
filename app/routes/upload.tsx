...
const Upload = () => {
  ...
  const handleAnayze=async ({companyName,jobTitle,jobDescription,file}: {companyName: string, jobTitle: string, jobDescription: string , file: File})=>{
      ...
      <section className="main-section">
        <div className="page-heading py-16">
          ...
          {isProcessing ? (
            ...
            <h2>Drop ypur resume for an ATS score and improvement tips</h2>
          )}
          {!isProcessing && (
